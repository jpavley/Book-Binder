...
class JsonModelTests: XCTestCase {
    ...
    func testAddVariantWork() {
        ...
        testModel2.addVariantWork(workNumber: 4, letter: "a")
        XCTAssertEqual(testModel2.selectedVolumeCompleteWorkIDs, ["1", "1a", "1b", "2", "3", "4", "4a", "5", "6", "7", "8", "8b", "9", "10"])
        
        testModel2.addVariantWork(workNumber: 5, letter: "b&w")
        ...
        testModel2.addVariantWork(workNumber: 6, letter: "")
        XCTAssertEqual(testModel2.selectedVolumeCompleteWorkIDs, ["1", "1a", "1b", "2", "3", "4", "4a", "5", "5b&w", "6", "7", "8", "8b", "9", "10"])
                
        // defend against a string that will create a duplicate variant
        testModel2.addVariantWork(workNumber: 1, letter: "a")
        XCTAssertEqual(testModel2.selectedVolumeCompleteWorkIDs, ["1", "1a", "1b", "2", "3", "4", "4a", "5", "5b&w", "6", "7", "8", "8b", "9", "10"])
    }
    ...
    func testSelectWork() {
        ...
        let newWork = testModel2.addVariantWork(workNumber: 1, letter: "x")
